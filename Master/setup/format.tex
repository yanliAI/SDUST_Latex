...
\makeatletter
\renewcommand\normalsize{
	\@setfontsize\normalsize{12pt}{20pt} % 小四 行间距20pt 数学公式前后的距离为 8pt
...
\titleformat{\chapter}{\bfseries\xiaoer\hei\duanjianju}{\chaptertitlename}{0.8em}{}
\titlespacing{\chapter}{0pt}{-5.3mm}{4.2mm}
\titleformat{\section}{\xiaosan\hei}{\thesection}{0.5em}{\setlength{\parskip}{20pt}}
...
\renewcommand{\bibname}{\hei\bfseries\xiaoer \centerline{参考文献}\vspace{-2em}} 
...
%\fancyhead[CE]{\wuhao  \raggedright{山东科技大学论文} \leftmark}
