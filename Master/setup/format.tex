...
\titlecontents{chapter}[0em]{\hei\xiaosi}{\thecontentslabel~~}{}{\titlerule*[4pt]{.}\contentspage}
\dottedcontents{section}[38pt]{\xiaosi}{22pt}{0.3pc}
...
\titleformat{\chapter}{\bfseries\xiaoer\hei}{\chaptertitlename}{0.8em}{}
...
\fancyhf{}
\fancyhead[RO]{\wuhao \leftmark}
\fancyhead[LO]{\wuhao 山东科技大学硕士学位论文}
